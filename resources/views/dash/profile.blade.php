    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0 flex-grow-1">Informasi User</h4>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="{{ old('username', @$data->username) }}" required>
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-lg-12">
